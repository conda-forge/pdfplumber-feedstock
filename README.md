...
Once the `conda-forge` channel has been enabled, `pdfplumber` can be installed with:

```
conda install pdfplumber
```

It is possible to list all of the versions of `pdfplumber` available on your platform with:
